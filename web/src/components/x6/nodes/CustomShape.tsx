...
export default ({ node }: { node: Node; graph: Graph }) => {
  node.setSize({ width: 200, height: 36 });
  ...
  return (
    ...
    >
      <div style={{ width: "40px", height: "30px", lineHeight: "30px", borderRight: "1px dashed #aaa", textAlign: "center" }}>{NodeTypeTitle[nodeType]}</div>
